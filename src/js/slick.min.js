!(function (i) {
  ...
  ((e = (function () {
    ...
    (e.prototype.getSlideCount = function () {
      ...
      return (
        ...
        !0 === o.options.swipeToSlide
          ? (o.$slideTrack.find(".slick-slide").each((s, n) => {
    ...
    (e.prototype.initADA = function () {
      ...
      var o = e.getNavigableIndexes().filter((i) => i >= 0 && i < e.slideCount);
      e.$slides
    ...
    (e.prototype.selectHandler = function (e) {
      var t = this;
      var o = i(e.target).is(".slick-slide")
        ? i(e.target)
    ...
    (e.prototype.swipeHandler = function (i) {
      ...
      if (
        !(
          ...
          (!1 === e.options.draggable && i.type.indexOf("mouse") !== -1)
        )
      )
        switch (
